          ...
          {!uploadedVideo && !uploading && (
            <div
              className={`border-2 border-dashed rounded-2xl p-12 text-center transition-all duration-200 ${
                dragActive
                  ? 'border-[#FF7A00] bg-gradient-to-r from-[#FF7A00]/10 to-[#A100FF]/10'
                  : 'border-gray-300 hover:border-[#FF7A00] hover:bg-gradient-to-r hover:from-gray-50 hover:to-[#FF7A00]/5'
              }`}
            ...
            >
              <div className="space-y-6">
                <div className="bg-gradient-to-r from-[#FF7A00] to-[#A100FF] text-white p-4 rounded-full w-fit mx-auto shadow-md">
                ...
                <button
                  ...
                  className="bg-gradient-to-r from-[#FF7A00] to-[#A100FF] text-white px-8 py-3 rounded-full font-semibold shadow-md hover:shadow-lg transform hover:scale-105 transition-all duration-200"
                >
                  Choose File
                </button>
